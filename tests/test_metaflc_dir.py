...
class TestMetaflacDir(TestCase):
    ...
    def _test_metaflac_dir(self, testdir, yaml):
        dirname = testdir
        create_test_directory(dirname)
        copy_to_test_directory(dirname, [yaml, '01.flac', '01.flac.expected'])
        ...
        assert_test_files_identity(self, dirname, [yaml, '01.flac.expected'])
